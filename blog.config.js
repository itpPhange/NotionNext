...
const BLOG = {
  ...
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'light', // ['auto', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '飞流', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://feiliuzhixiasanqianchi.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '干饭人的博客', // 网站关键词 英文逗号隔开
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || 'ZXMEQT0XAP', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || '3b797c6e7c7cf265978aff357872638e', // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY: process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || 'bd9a565abc0dc9d4df48c05a53bf542a', // 客户端搜索用的KEY
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.feiliuzhixiasanqianchi.top/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
